return {
	...
	config = function()
		...
		map("n", "<leader><leader>h", function() harpoon:list():replace_at(1) end)
		map("n", "<leader><leader>j", function() harpoon:list():replace_at(2) end)
		map("n", "<leader><leader>k", function() harpoon:list():replace_at(3) end)
		map("n", "<leader><leader>l", function() harpoon:list():replace_at(4) end)
		map("n", "<leader><leader>;", function() harpoon:list():replace_at(5) end)
