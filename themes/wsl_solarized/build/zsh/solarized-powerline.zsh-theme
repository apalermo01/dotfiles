# take from https://github.com/bbhands/oh-my-zsh-solarized-powerline-theme/blob/master/solarized-powerline.zsh-theme
...
if [ $ZSH_POWERLINE_SHOW_USER = true ]; then
    local _user="%n"
    PROMPT="${PROMPT}${FG_COLOR_BLUE}${BG_COLOR_BASE3}${PADDING}${_user}"
    PADDING=' '
fi
